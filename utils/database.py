...
def load_embedding_model(contriever=EMBEDDING_MODEL_NAME):
    if contriever in 'sentence-transformers/all-mpnet-base-v2':
        EMBEDDING_MODEL = 'sentence-transformers/all-mpnet-base-v2' # 'BAAI/bge-base-en-v1.5' # 'sentence-transformers/all-mpnet-base-v2''BAAI/bge-base-en-v1.5' 'intfloat/e5-base-v2' sentence-transformers/multi-qa-mpnet-base-dot-v1
    elif contriever in 'BAAI/bge-base-en-v1.5':
        EMBEDDING_MODEL = 'BAAI/bge-base-en-v1.5' 
    elif contriever in 'intfloat/e5-base-v2':
...
def load_rag_database(dataset_name_list,contriever_name,language='python'):
    if contriever_name in 'sentence-transformers/all-mpnet-base-v2':
        EMBEDDING_MODEL = 'sentence-transformers/all-mpnet-base-v2' # 'BAAI/bge-base-en-v1.5' # 'sentence-transformers/all-mpnet-base-v2''BAAI/bge-base-en-v1.5' 'intfloat/e5-base-v2' sentence-transformers/multi-qa-mpnet-base-dot-v1
    elif contriever_name in 'BAAI/bge-base-en-v1.5':
        EMBEDDING_MODEL = 'BAAI/bge-base-en-v1.5' 
    elif contriever_name in 'intfloat/e5-base-v2':
        EMBEDDING_MODEL = 'intfloat/e5-base-v2'
    else:
